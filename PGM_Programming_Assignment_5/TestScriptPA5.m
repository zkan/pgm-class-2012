% Credit: https://class.coursera.org/pgm/forum/thread?thread_id=1508
% Many thanks to Tomas Krupka

% Test script to check the implementation with the values from 
% exampleIOPA5.mat

function TestScriptPA5(exampleINPUT, exampleOUTPUT, choice)
